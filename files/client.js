...
*/
  ...
  var E = {},
    F = function () {
      if (E !== E) throw Error("SafeStyle is not meant to be built directly");
      this.s = "";
    };
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  var G = window,
    ...
    K = function () {
      var a;
      if ((a = Object.create) && la.test(a)) a = a(null);
      else {
        a = {};
  ...
  var ua = /^(\/[a-zA-Z0-9_\-]+)+$/,
    ...
    Da = function (a) {
      ...
      c = 0;
      for (d = va.length; c < d; ++c) va[c].test(b) && V("invalid_prefix");
      c = W(a, "k", !0);
      d = W(a, "am");
      e = W(a, "rs");
      a = W(a, "t");
  ...
  var X = decodeURI("%73cript"),
    ...
    Ia = function () {
      var a = O.nonce;
      return a !== void 0
        ? a && a === String(a) && a.match(Ga)
          ? a
          : (O.nonce = null)
        : I.querySelector
        ? (a = I.querySelector("script[nonce]"))
    ...
    Ja = function (a) {
      ...
      b.async = "true";
      (a = I.getElementsByTagName(X)[0])
        ? a.parentNode.insertBefore(b, a)
        : (I.head || I.body || I.documentElement).appendChild(b);
    },
    Ma = function (a, b, c) {
      La(function () {
    ...
    Oa = function (a, b) {
      ...
      if (!(a = c.h) && ((a = na()), !a)) throw Error("Bad hint: !hint");
      Na(b || [], c, a);
    },
    Na = function (a, b, c) {
      a = ma(a) || [];
  ...
  window.gapi.load("", {
    ...
    _c: {
      ...
      jsl: {
        ...
        h: "m;/_/scs/abc-static/_/js/k=gapi.lb.zh_TW.8SCfxndKM6M.O/am=AAAg/d=1/rs=AHpOoo_r0dgqBnuXWp3ofCweupgmEcZxrw/m=__features__",
